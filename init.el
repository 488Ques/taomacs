...
(custom-set-variables
 ...
 '(package-selected-packages
   '(web-mode dracula which-key use-package swiper sudo-edit smex smart-hungry-delete rainbow-mode rainbow-delimiters powerline page-break-lines magit ido-vertical-mode go-mode flycheck exec-path-from-shell eglot dracula-theme dired-sidebar diminish dashboard company ace-window)))
(custom-set-faces
